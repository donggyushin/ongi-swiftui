...
public struct ProfileEntitiy {
    ...
    public init(id: String, nickname: String, email: String?, profileImage: ImageEntity?, images: [ImageEntity], mbti: MBTIEntity?, qnas: [QnAEntity], gender: GenderEntity?, height: CGFloat?, weight: CGFloat?, bodyType: BodyType?, createdAt: Date, updatedAt: Date) {
        self.id = id
